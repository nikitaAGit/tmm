            ...
            <div className="container">
                <div className={s.inner}>
                    <div className={s.header}>
                        <img className={s.headerImg} src="../../../../../public/About/about_min2.jpg" alt="" />
                        ...
                        <img className={`${s.headerImg} ${s.headerImgHidden}`} src="../../../../../public/About/about_min2.jpg" alt="" />
                    </div>
                    <div className={s.main}>
                        ...
                        <img className={s.mainImg} src="../../../../../public/About/aboutContent.jpg" alt="" />
                    </div>
                </div>
            </div>
        </div>
